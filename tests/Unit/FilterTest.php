...
{
    /** @test */
    public function if_the_filter_does_not_exist_the_previous_value_will_be_returned()
    {
        $values = [
            [
                'key' => 'FECHA',
    ...
    /** @test */
    public function it_can_apply_the_filter_date_letter()
    {
    ...
    /** @test */
    public function it_can_apply_the_filter_number_letter()
    {
        $values = [
            [
                'key' => 'MONTO',
    ...
    /** @test */
    public function it_can_apply_filter_number_format()
    {
        $values = [
            [
                'key' => 'MONTO',
    ...
    /** @test */
    public function it_can_apply_filter_date_format()
    {
        $values = [
            [
                'key' => 'FECHA',
    ...
    /** @test */
    public function it_can_apply_filter_lowercase()
    {
        $values = [
             [
                 'key' => 'NOMBRE',
    ...
    /** @test */
    public function it_can_apply_filter_uppercase()
    {
        $values = [
              [
                  'key' => 'NOMBRE',
    ...
    /** @test */
    public function it_can_apply_filter_capitalize()
    {
        $values = [
               [
                   'key' => 'NOMBRE',
    ...
    /** @test */
    public function it_can_apply_filters_lowercase_and_capitalize()
    {
        $values = [
                [
                    'key' => 'NOMBRE',
